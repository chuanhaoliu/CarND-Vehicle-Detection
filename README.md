...
* *.ipynb - the jupyter nootbooks of "p5-vehicle-detection"
* *.py - code for handling pipeline
* project_video.mp4 - test video
* project_video_output.mp4 - test video after the handling pipeline	
* output_images - image folder for referencing by writeup
* test_images - image folder for testing the algorithm
* model.p - the training classifier model
